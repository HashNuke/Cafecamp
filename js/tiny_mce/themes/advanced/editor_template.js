	...
	getControlHTML : function(button_name) {
		...
		switch (button_name) {
			case "formatselect":
				...
				var formats = tinyMCE.getParam("theme_advanced_blockformats", "h2,h3,h4", true).split(',');
				var lookup = [
					['h2', '{$lang_theme_h2}'],
					['h3', '{$lang_theme_h3}'],
					['h4', '{$lang_theme_h4}']
	...
	getEditorTemplate : function(settings, editorId) {
		...
		switch(layoutManager) {
			case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
				...
				var defVals = {
					theme_advanced_buttons1 : "bold,italic,underline,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,bullist,numlist,separator,image,charmap,separator,formatselect"
				};
